            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        ...
                        <a href="<%=Common_Things.url %>/issue-book-student/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-warning">Issue Book</a>
                                                    ...
                                                    <form action="<%=Common_Things.url%>/add-student-contro/" class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Grade" name="grade" value="<%if(obj_Student_Use_Bean.getGrade()!=null){out.println(obj_Student_Use_Bean.getGrade());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                     ...
                                                     <hr>  
                                                        ...
                                                        <div class="form-group">  
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                ...
                                                                <a href="<%=Common_Things.url %>/edit-profile-student/?lm=<%=obj_Student_Use_Bean.getStudent_id() %>" class="btn btn-warning">Edit Profile</a>
